...
- **Конфигурации**: создание, редактирование и удаление конфигураций запуска (имя + флаги), выбор активной конфигурации, запуск с конфигурацией на время.
...
- **Автосохранение**: все настройки сохраняются в `settings.json`
...
- **Меню конфигураций / туннелей**:
  ...
  - `c` — создать новую конфигурацию / средство туннелирования
  - `d` — удалить выделенный элемент
  - `o` — (в меню конфигов) скопировать флаги в буфер обмена
  - `r` - (в меню конфигов) запустить с конфигурацией на время
  - `b` / `esc` — назад
- **Окно логов**:
