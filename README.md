...
**Фазы можно менять в файле `phases.yml`**
...
4. **Shaper трафика:** Может использоваться чтобы создать непредсказуемый паттерн трафика и затруднить для DPI статистический анализ.
