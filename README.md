...
*   **База:** QUIC (UDP) с BBR.
*   **Маскировка:** Маскарад под HTTPS.
    * В Umbrella модифицирован до уровня XTLS Reality с защитой от probbing.
...
*   **Маскировка:** Кража личности (Reality) легитимного сайта + "тонировка" Vision
    * Vision в Umbrella модифицирован для постоянной маскировки как TLS-in-TLS сигнатур так и всего полезного трафика приложений засчет постоянного рандомного паддинга.
