...
В отличие от классической Hysteria, реализация в Umbrella Protocol включает кастомную надстройку (Flawless Masquerade) для обеспечения максимальной скрытности (**из-за этого не поддерживается режим Salamander**):
